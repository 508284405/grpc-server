...
public final class ProductInfoGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.grpcserver.grpc.ProductInfoOuterClass.Product,
      com.example.grpcserver.grpc.ProductInfoOuterClass.ProductID> getAddProductMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "addProduct",
      requestType = com.example.grpcserver.grpc.ProductInfoOuterClass.Product.class,
      responseType = com.example.grpcserver.grpc.ProductInfoOuterClass.ProductID.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.grpcserver.grpc.ProductInfoOuterClass.Product,
      com.example.grpcserver.grpc.ProductInfoOuterClass.ProductID> getAddProductMethod() {
    io.grpc.MethodDescriptor<com.example.grpcserver.grpc.ProductInfoOuterClass.Product, com.example.grpcserver.grpc.ProductInfoOuterClass.ProductID> getAddProductMethod;
      ...
      synchronized (ProductInfoGrpc.class) {
        if ((getAddProductMethod = ProductInfoGrpc.getAddProductMethod) == null) {
          ProductInfoGrpc.getAddProductMethod = getAddProductMethod =
              io.grpc.MethodDescriptor.<com.example.grpcserver.grpc.ProductInfoOuterClass.Product, com.example.grpcserver.grpc.ProductInfoOuterClass.ProductID>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "addProduct"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpcserver.grpc.ProductInfoOuterClass.Product.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpcserver.grpc.ProductInfoOuterClass.ProductID.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.grpcserver.grpc.ProductInfoOuterClass.ProductID,
      com.example.grpcserver.grpc.ProductInfoOuterClass.Product> getGetProductMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getProduct",
      requestType = com.example.grpcserver.grpc.ProductInfoOuterClass.ProductID.class,
      responseType = com.example.grpcserver.grpc.ProductInfoOuterClass.Product.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.grpcserver.grpc.ProductInfoOuterClass.ProductID,
      com.example.grpcserver.grpc.ProductInfoOuterClass.Product> getGetProductMethod() {
    io.grpc.MethodDescriptor<com.example.grpcserver.grpc.ProductInfoOuterClass.ProductID, com.example.grpcserver.grpc.ProductInfoOuterClass.Product> getGetProductMethod;
    if ((getGetProductMethod = ProductInfoGrpc.getGetProductMethod) == null) {
      synchronized (ProductInfoGrpc.class) {
        if ((getGetProductMethod = ProductInfoGrpc.getGetProductMethod) == null) {
          ProductInfoGrpc.getGetProductMethod = getGetProductMethod =
              io.grpc.MethodDescriptor.<com.example.grpcserver.grpc.ProductInfoOuterClass.ProductID, com.example.grpcserver.grpc.ProductInfoOuterClass.Product>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
  ...
  public static abstract class ProductInfoImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void addProduct(com.example.grpcserver.grpc.ProductInfoOuterClass.Product request,
        io.grpc.stub.StreamObserver<com.example.grpcserver.grpc.ProductInfoOuterClass.ProductID> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getAddProductMethod(), responseObserver);
    }

    /**
     */
    public void getProduct(com.example.grpcserver.grpc.ProductInfoOuterClass.ProductID request,
        io.grpc.stub.StreamObserver<com.example.grpcserver.grpc.ProductInfoOuterClass.Product> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.example.grpcserver.grpc.ProductInfoOuterClass.Product,
                com.example.grpcserver.grpc.ProductInfoOuterClass.ProductID>(
  ...
  public static final class ProductInfoBlockingStub extends io.grpc.stub.AbstractBlockingStub<ProductInfoBlockingStub> {
    ...
    /**
     */
    public com.example.grpcserver.grpc.ProductInfoOuterClass.ProductID addProduct(com.example.grpcserver.grpc.ProductInfoOuterClass.Product request) {
    ...
    /**
     */
    public com.example.grpcserver.grpc.ProductInfoOuterClass.Product getProduct(com.example.grpcserver.grpc.ProductInfoOuterClass.ProductID request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class ProductInfoFutureStub extends io.grpc.stub.AbstractFutureStub<ProductInfoFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.grpcserver.grpc.ProductInfoOuterClass.ProductID> addProduct(
        com.example.grpcserver.grpc.ProductInfoOuterClass.Product request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.grpcserver.grpc.ProductInfoOuterClass.Product> getProduct(
        com.example.grpcserver.grpc.ProductInfoOuterClass.ProductID request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ADD_PRODUCT:
          serviceImpl.addProduct((com.example.grpcserver.grpc.ProductInfoOuterClass.Product) request,
              (io.grpc.stub.StreamObserver<com.example.grpcserver.grpc.ProductInfoOuterClass.ProductID>) responseObserver);
          break;
        case METHODID_GET_PRODUCT:
          serviceImpl.getProduct((com.example.grpcserver.grpc.ProductInfoOuterClass.ProductID) request,
              (io.grpc.stub.StreamObserver<com.example.grpcserver.grpc.ProductInfoOuterClass.Product>) responseObserver);
          break;
        default:
  ...
  private static abstract class ProductInfoBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.grpcserver.grpc.ProductInfoOuterClass.getDescriptor();
    }
